...
<html>
    ...
    <h1 style="text-align:center;font-size:larger">Servicios</h1>
<div class="table-responsive" id="mydatatable-container">
    <table class="records_list table table-striped table-bordered table-hover" id="mydatatable">
        <thead>
        <a style='font-size: 20px;' href="pdf_servicios.php">Exportar PDF
            ...
            foreach ($retorno as $fila)
                    {
                        ...
                        "<td>
                        <a  href='acti_inacti_servicio.php?
                        a=".(INT)$fila ["id_servicio"]."& 
                        b=".(int)(2)."'>
