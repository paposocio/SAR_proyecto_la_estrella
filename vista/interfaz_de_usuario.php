        ...
        <div class="wrapper">
            ...
            <div class="sidebar">
                <div class="sidebar-menu">
                    ...
                    <li class="item" id="usuarios">
                        ...
                        <div class="sub-menu">
                            <a href="#" id="userbtn"><i class="fas fa-address-card"></i><span>Informacion</span></a>
                        </div>
                    </li>
                    <!--sidebar start-->
            ...
            <div class="main-container" >
                ...
                if ($_SESSION['rol']=='residente')
                {
                    ...
                    <iframe src='../controlador/funciones/registro_cita_usuario.php'; width=100% height=800></iframe>
                    </div>
                    ";
                }
                else if($_SESSION['rol']=='vigilante')
                {
                    echo "
                    <div class='card' id='contenido_citas'>
